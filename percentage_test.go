...
func TestPercentage_position_left_top(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeLeft, 10)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeTop, 20)
...
func TestPercentage_position_bottom_right(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeRight, 20)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeBottom, 10)
...
func TestPercentage_multiple_nested_with_padding_margin_and_percentage_values(t *testing.T) {
	...
	YGNodeStyleSetFlexGrow(rootChild0, 1)
	YGNodeStyleSetFlexBasisPercent(rootChild0, 10)
	YGNodeStyleSetMargin(rootChild0, YGEdgeLeft, 5)
	YGNodeStyleSetMargin(rootChild0, YGEdgeTop, 5)
	YGNodeStyleSetMargin(rootChild0, YGEdgeRight, 5)
	YGNodeStyleSetMargin(rootChild0, YGEdgeBottom, 5)
	YGNodeStyleSetPadding(rootChild0, YGEdgeLeft, 3)
	YGNodeStyleSetPadding(rootChild0, YGEdgeTop, 3)
	YGNodeStyleSetPadding(rootChild0, YGEdgeRight, 3)
	YGNodeStyleSetPadding(rootChild0, YGEdgeBottom, 3)
	YGNodeStyleSetMinWidthPercent(rootChild0, 60)
	YGNodeInsertChild(root, rootChild0, 0)

	rootChild0Child0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetMargin(rootChild0Child0, YGEdgeLeft, 5)
	YGNodeStyleSetMargin(rootChild0Child0, YGEdgeTop, 5)
	YGNodeStyleSetMargin(rootChild0Child0, YGEdgeRight, 5)
	YGNodeStyleSetMargin(rootChild0Child0, YGEdgeBottom, 5)
	YGNodeStyleSetPaddingPercent(rootChild0Child0, YGEdgeLeft, 3)
	YGNodeStyleSetPaddingPercent(rootChild0Child0, YGEdgeTop, 3)
	YGNodeStyleSetPaddingPercent(rootChild0Child0, YGEdgeRight, 3)
	YGNodeStyleSetPaddingPercent(rootChild0Child0, YGEdgeBottom, 3)
	YGNodeStyleSetWidthPercent(rootChild0Child0, 50)
	YGNodeInsertChild(rootChild0, rootChild0Child0, 0)

	rootChild0Child0_child0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetMarginPercent(rootChild0Child0_child0, YGEdgeLeft, 5)
	YGNodeStyleSetMarginPercent(rootChild0Child0_child0, YGEdgeTop, 5)
	YGNodeStyleSetMarginPercent(rootChild0Child0_child0, YGEdgeRight, 5)
	YGNodeStyleSetMarginPercent(rootChild0Child0_child0, YGEdgeBottom, 5)
	YGNodeStyleSetPadding(rootChild0Child0_child0, YGEdgeLeft, 3)
	YGNodeStyleSetPadding(rootChild0Child0_child0, YGEdgeTop, 3)
	YGNodeStyleSetPadding(rootChild0Child0_child0, YGEdgeRight, 3)
	YGNodeStyleSetPadding(rootChild0Child0_child0, YGEdgeBottom, 3)
...
func TestPercentage_margin_should_calculate_based_only_on_width(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetFlexGrow(rootChild0, 1)
	YGNodeStyleSetMarginPercent(rootChild0, YGEdgeLeft, 10)
	YGNodeStyleSetMarginPercent(rootChild0, YGEdgeTop, 10)
	YGNodeStyleSetMarginPercent(rootChild0, YGEdgeRight, 10)
	YGNodeStyleSetMarginPercent(rootChild0, YGEdgeBottom, 10)
	YGNodeInsertChild(root, rootChild0, 0)
...
func TestPercentage_padding_should_calculate_based_only_on_width(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetFlexGrow(rootChild0, 1)
	YGNodeStyleSetPaddingPercent(rootChild0, YGEdgeLeft, 10)
	YGNodeStyleSetPaddingPercent(rootChild0, YGEdgeTop, 10)
	YGNodeStyleSetPaddingPercent(rootChild0, YGEdgeRight, 10)
	YGNodeStyleSetPaddingPercent(rootChild0, YGEdgeBottom, 10)
	YGNodeInsertChild(root, rootChild0, 0)
...
func TestPercentage_absolute_position(t *testing.T) {
	...
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeLeft, 30)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeTop, 10)
...
func TestPercent_absolute_position(t *testing.T) {
	...
	YGNodeStyleSetPositionType(rootChild0, YGPositionTypeAbsolute)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeLeft, 50)
