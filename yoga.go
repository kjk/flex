...
func init() {
	...
	dim[YGFlexDirectionColumn] = YGDimensionHeight
	dim[YGFlexDirectionColumnReverse] = YGDimensionHeight
	dim[YGFlexDirectionRow] = YGDimensionWidth
	dim[YGFlexDirectionRowReverse] = YGDimensionWidth
}
