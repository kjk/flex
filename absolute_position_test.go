...
func AbsoluteLayoutStartTopEndBottomTest(t *testing.T) {
	config := YGConfigNew()
	...
	assert.Equal(t, 10, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 10, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 80, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 80, YGNodeLayoutGetHeight(root_child0))
...
func DoNotClampHeightOfAbsoluteNodeToHeightOfItsOverflowHiddenParentTest(t *testing.T) {
	...
	assert.Equal(t, 0, YGNodeLayoutGetLeft(root))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root))
	assert.Equal(t, 50, YGNodeLayoutGetWidth(root))
	assert.Equal(t, 50, YGNodeLayoutGetHeight(root))

	assert.Equal(t, 0, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 100, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 100, YGNodeLayoutGetHeight(root_child0))

	assert.Equal(t, 0, YGNodeLayoutGetLeft(root_child0_child0))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root_child0_child0))
	assert.Equal(t, 100, YGNodeLayoutGetWidth(root_child0_child0))
	assert.Equal(t, 100, YGNodeLayoutGetHeight(root_child0_child0))
	...
	assert.Equal(t, -50, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 100, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 100, YGNodeLayoutGetHeight(root_child0))
...
func AbsoluteLayoutWithinBorderTest(t *testing.T) {
	...
	assert.Equal(t, 10, YGNodeLayoutGetLeft(root))
	assert.Equal(t, 10, YGNodeLayoutGetTop(root))
	assert.Equal(t, 100, YGNodeLayoutGetWidth(root))
	assert.Equal(t, 100, YGNodeLayoutGetHeight(root))

	assert.Equal(t, 10, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 10, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 50, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 50, YGNodeLayoutGetHeight(root_child0))

	assert.Equal(t, 40, YGNodeLayoutGetLeft(root_child1))
	assert.Equal(t, 40, YGNodeLayoutGetTop(root_child1))
	assert.Equal(t, 50, YGNodeLayoutGetWidth(root_child1))
	assert.Equal(t, 50, YGNodeLayoutGetHeight(root_child1))

	assert.Equal(t, 20, YGNodeLayoutGetLeft(root_child2))
	assert.Equal(t, 20, YGNodeLayoutGetTop(root_child2))
	assert.Equal(t, 50, YGNodeLayoutGetWidth(root_child2))
	assert.Equal(t, 50, YGNodeLayoutGetHeight(root_child2))

	assert.Equal(t, 30, YGNodeLayoutGetLeft(root_child3))
	assert.Equal(t, 30, YGNodeLayoutGetTop(root_child3))
	assert.Equal(t, 50, YGNodeLayoutGetWidth(root_child3))
	assert.Equal(t, 50, YGNodeLayoutGetHeight(root_child3))
...
func AbsoluteLayoutAlignItemsAndJustifyContentCenterTest(t *testing.T) {
	...
	assert.Equal(t, 0, YGNodeLayoutGetLeft(root))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root))
	assert.Equal(t, 110, YGNodeLayoutGetWidth(root))
	assert.Equal(t, 100, YGNodeLayoutGetHeight(root))

	assert.Equal(t, 25, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 30, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 60, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 40, YGNodeLayoutGetHeight(root_child0))
...
func AbsoluteLayoutAlignItemsAndJustifyContentFlexEndText(t *testing.T) {
	...
	assert.Equal(t, 50, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 60, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 60, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 40, YGNodeLayoutGetHeight(root_child0))
...
func AbsoluteLayoutAlignItemsAndJustifyContentCenterAndBottomPositionTest(t *testing.T) {
	...
	assert.Equal(t, 25, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 50, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 60, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 40, YGNodeLayoutGetHeight(root_child0))
...
func AbsoluteLayoutAlignItemsAndJustifyContentCenterAndLeftPositionTest(t *testing.T) {
	...
	assert.Equal(t, 5, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 30, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 60, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 40, YGNodeLayoutGetHeight(root_child0))
...
func absolute_layout_align_items_and_justify_content_center_and_right_positionTest(t *testing.T) {
	...
	assert.Equal(t, 45, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 30, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 60, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 40, YGNodeLayoutGetHeight(root_child0))
...
func position_root_with_rtl_should_position_withoutdirectionTest(t *testing.T) {
	...
	assert.Equal(t, 72, YGNodeLayoutGetLeft(root))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root))
	assert.Equal(t, 52, YGNodeLayoutGetWidth(root))
	assert.Equal(t, 52, YGNodeLayoutGetHeight(root))
...
func absolute_layout_percentage_bottom_based_on_parent_heightTest(t *testing.T) {
	...
	assert.Equal(t, 0, YGNodeLayoutGetTop(root))
	assert.Equal(t, 100, YGNodeLayoutGetWidth(root))
	assert.Equal(t, 200, YGNodeLayoutGetHeight(root))

	assert.Equal(t, 0, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 100, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 10, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 10, YGNodeLayoutGetHeight(root_child0))

	assert.Equal(t, 0, YGNodeLayoutGetLeft(root_child1))
	assert.Equal(t, 90, YGNodeLayoutGetTop(root_child1))
	assert.Equal(t, 10, YGNodeLayoutGetWidth(root_child1))
	assert.Equal(t, 10, YGNodeLayoutGetHeight(root_child1))

	assert.Equal(t, 0, YGNodeLayoutGetLeft(root_child2))
	assert.Equal(t, 20, YGNodeLayoutGetTop(root_child2))
	assert.Equal(t, 10, YGNodeLayoutGetWidth(root_child2))
	assert.Equal(t, 160, YGNodeLayoutGetHeight(root_child2))
	...
	assert.Equal(t, 90, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 100, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 10, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 10, YGNodeLayoutGetHeight(root_child0))

	assert.Equal(t, 90, YGNodeLayoutGetLeft(root_child1))
	assert.Equal(t, 90, YGNodeLayoutGetTop(root_child1))
	assert.Equal(t, 10, YGNodeLayoutGetWidth(root_child1))
	assert.Equal(t, 10, YGNodeLayoutGetHeight(root_child1))

	assert.Equal(t, 90, YGNodeLayoutGetLeft(root_child2))
	assert.Equal(t, 20, YGNodeLayoutGetTop(root_child2))
	assert.Equal(t, 10, YGNodeLayoutGetWidth(root_child2))
	assert.Equal(t, 160, YGNodeLayoutGetHeight(root_child2))
...
func absolute_layout_in_wrap_reverse_column_containerTest(t *testing.T) {
	...
	assert.Equal(t, 80, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 0, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 20, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 20, YGNodeLayoutGetHeight(root_child0))
...
func absolute_layout_in_wrap_reverse_row_containerTest(t *testing.T) {
	...
	assert.Equal(t, 0, YGNodeLayoutGetLeft(root_child0))
	assert.Equal(t, 80, YGNodeLayoutGetTop(root_child0))
	assert.Equal(t, 20, YGNodeLayoutGetWidth(root_child0))
	assert.Equal(t, 20, YGNodeLayoutGetHeight(root_child0))
