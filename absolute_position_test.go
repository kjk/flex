...
func TestAbsoluteLayoutWidthHeightStartTop(t *testing.T) {
	...
	YGNodeStyleSetPosition(rootChild0, YGEdgeStart, 10)
...
func TestAbsoluteLayoutStartTopEndBottom(t *testing.T) {
	...
	YGNodeStyleSetPosition(rootChild0, YGEdgeStart, 10)
	YGNodeStyleSetPosition(rootChild0, YGEdgeTop, 10)
	YGNodeStyleSetPosition(rootChild0, YGEdgeEnd, 10)
...
func TestDoNotClampHeightOfAbsoluteNodeToHeightOfItsOverflowHiddenParent(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild0, YGPositionTypeAbsolute)
	YGNodeStyleSetPosition(rootChild0, YGEdgeStart, 0)
...
func TestAbsoluteLayoutWithinBorder(t *testing.T) {
	...
	YGNodeStyleSetPositionType(rootChild1, YGPositionTypeAbsolute)
	YGNodeStyleSetPosition(rootChild1, YGEdgeRight, 0)
	YGNodeStyleSetPosition(rootChild1, YGEdgeBottom, 0)
	YGNodeStyleSetWidth(rootChild1, 50)
	YGNodeStyleSetHeight(rootChild1, 50)
	YGNodeInsertChild(root, rootChild1, 1)

	rootChild2 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild2, YGPositionTypeAbsolute)
	YGNodeStyleSetPosition(rootChild2, YGEdgeLeft, 0)
	YGNodeStyleSetPosition(rootChild2, YGEdgeTop, 0)
	YGNodeStyleSetMargin(rootChild2, YGEdgeLeft, 10)
	YGNodeStyleSetMargin(rootChild2, YGEdgeTop, 10)
	YGNodeStyleSetMargin(rootChild2, YGEdgeRight, 10)
	YGNodeStyleSetMargin(rootChild2, YGEdgeBottom, 10)
	...
	YGNodeStyleSetPositionType(rootChild3, YGPositionTypeAbsolute)
	YGNodeStyleSetPosition(rootChild3, YGEdgeRight, 0)
	YGNodeStyleSetPosition(rootChild3, YGEdgeBottom, 0)
...
func TestAbsoluteLayoutAlignItemsAndJustifyContentCenterAndLeftPosition(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild0, YGPositionTypeAbsolute)
	YGNodeStyleSetPosition(rootChild0, YGEdgeLeft, 5)
	YGNodeStyleSetWidth(rootChild0, 60)
	YGNodeStyleSetHeight(rootChild0, 40)
	YGNodeInsertChild(root, rootChild0, 0)
	YGNodeCalculateLayout(root, YGUndefined, YGUndefined, DirectionLTR)
...
func TestAbsolute_layout_align_items_and_justify_content_center_and_right_position(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild0, YGPositionTypeAbsolute)
	YGNodeStyleSetPosition(rootChild0, YGEdgeRight, 5)
	YGNodeStyleSetWidth(rootChild0, 60)
	YGNodeStyleSetHeight(rootChild0, 40)
	YGNodeInsertChild(root, rootChild0, 0)
	YGNodeCalculateLayout(root, YGUndefined, YGUndefined, DirectionLTR)
...
func TestAbsolute_layout_percentage_bottom_based_on_parent_height(t *testing.T) {
	...
	rootChild0 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild0, YGPositionTypeAbsolute)
	YGNodeStyleSetPositionPercent(rootChild0, YGEdgeTop, 50)
	YGNodeStyleSetWidth(rootChild0, 10)
	YGNodeStyleSetHeight(rootChild0, 10)
	YGNodeInsertChild(root, rootChild0, 0)
	...
	rootChild1 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild1, YGPositionTypeAbsolute)
	YGNodeStyleSetPositionPercent(rootChild1, YGEdgeBottom, 50)
	...
	rootChild2 := YGNodeNewWithConfig(config)
	YGNodeStyleSetPositionType(rootChild2, YGPositionTypeAbsolute)
	YGNodeStyleSetPositionPercent(rootChild2, YGEdgeTop, 10)
	YGNodeStyleSetPositionPercent(rootChild2, YGEdgeBottom, 10)
